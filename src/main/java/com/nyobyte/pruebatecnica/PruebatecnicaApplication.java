...
public class PruebatecnicaApplication {
	...
	public CorsFilter corsFilter(){
		...
		UrlBasedCorsConfigurationSource urlBasedCrosConfigSource = new UrlBasedCorsConfigurationSource();
		urlBasedCrosConfigSource.registerCorsConfiguration("/**", corsConfig);
		return new CorsFilter(urlBasedCrosConfigSource);
	}
}
